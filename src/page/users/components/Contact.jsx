  ...
  return (
    <section id="contact" className="bg-mono-100 py-12 sm:py-20">
      <div className="section-container px-4 sm:px-6 md:px-12 lg:px-16">
        ...
        <p className="subtitle text-center max-w-2xl mx-auto mb-8 sm:mb-16">Hãy liên hệ với tôi nếu bạn có nhu cầu hợp tác hoặc muốn trao đổi thêm về các dự án.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
          <div className="space-y-6 sm:space-y-8 md:col-span-1">
            ...
            <div className="flex items-start space-x-3 sm:space-x-4">
              <div className="bg-mono-900 text-mono-100 p-2 sm:p-3 rounded-full">
                <MessageIcon size={16} sm:size={20} />
              </div>
              <div>
          ...
          <div className="md:col-span-2">
            <form className="space-y-4 sm:space-y-6 bg-mono-50 p-4 sm:p-6 rounded-lg border border-mono-300">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  <label htmlFor="name" className="block mb-1 sm:mb-2 font-medium text-mono-900 text-sm sm:text-base">Họ và tên</label>
                  <input 
                    type="text" 
                    id="name" 
                ...
                <div>
                  <label htmlFor="email" className="block mb-1 sm:mb-2 font-medium text-mono-900 text-sm sm:text-base">Email</label>
                  <input 
                    type="email" 
                    id="email" 
                    className="contact-input w-full text-sm sm:text-base" 
              ...
              <div>
                <label htmlFor="subject" className="block mb-1 sm:mb-2 font-medium text-mono-900 text-sm sm:text-base">Tiêu đề</label>
                <input 
                  type="text" 
                  id="subject" 
                  className="contact-input w-full text-sm sm:text-base" 
              ...
              <div>
                <label htmlFor="message" className="block mb-1 sm:mb-2 font-medium text-mono-900 text-sm sm:text-base">Nội dung</label>
                <textarea 
                  id="message" 
                  rows={4} 
                  className="contact-input w-full text-sm sm:text-base" 
              ...
              <button type="submit" className="btn-primary w-full flex items-center justify-center text-sm sm:text-base">
                Gửi tin nhắn <SendIcon size={14} className="ml-1 sm:ml-2" />
              </button>
            </form>
          </div>
        </div>
